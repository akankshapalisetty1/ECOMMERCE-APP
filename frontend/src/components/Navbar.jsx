    ...
    <div className='flex items-center justify-between py-5 font-medium'> 
       ...
       <div className='flex items-center gap-6'>
             ...
             <div className='group relative'>
                <img onClick={()=> token ? null : navigate('/login')} className='w-11 cursor-pointer' src={assets.profile_icon} alt="" />
                {/* Dropdown Menu */}
                {token && 
             ...
             <Link to='/cart' className='relative'>
                 <img src={assets.cart_icon} className='w-4 min-w-4' alt="cart_icon" />
             ...
             <img onClick={()=>setvisible(true)} src={assets.menu_icon} className='w-6 cursor-pointer sm:hidden' alt="menu_icon" /> 
       </div> 
