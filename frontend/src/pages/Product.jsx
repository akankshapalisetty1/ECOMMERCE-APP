    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          ...
          <p>E-commerce helps designers and developers see how the website's layout will look with real content. Whether you're dressing up for a casual outing or lounging at home, this tee is versatile enough to match any mood or style. </p>
